...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Base', '0008_library_last_updated'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('library_manager', 'Library Manager')], max_length=20)),
