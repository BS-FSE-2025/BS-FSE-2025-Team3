...
class StudentProfile(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.SET_NULL, related_name='student_profile', null=True)
...
class LibraryManagerProfile(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.SET_NULL, related_name='library_manager_profile', null=True)
...
class AdminProfile(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.SET_NULL, related_name='admin_profile', null=True)
...
class LibraryHours(models.Model):
    day_of_week = models.CharField(max_length=20, unique=True)
